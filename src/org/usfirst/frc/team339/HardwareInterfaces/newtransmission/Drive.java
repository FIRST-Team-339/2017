...
public class Drive
{
	 ...
	 * 
	 * @param distance how far the robot should travel. Should always remain positive!
	 * @param speed how fast the robot should go while traveling. Negative for backwards.
