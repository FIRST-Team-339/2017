...
public class TransmissionMecanum extends TransmissionFourWheel {
	 ...
	 */
	public void driveNoDeadband(double magnitude, double direction, double rotation) {
	...
	public void drive(double magnitude, double direction, double rotation) {
		...
		if ((Math.abs(magnitude) >= super.getDeadbandPercentageZone())
				|| Math.abs(tempRotation) >= super.getDeadbandPercentageZone()) {

			if (tempDirection < this.getDirectionalDeadzone() && tempDirection > -this.getDirectionalDeadzone())
				tempDirection = 0;
			...
			// tempDirection = 135;
			else if (tempDirection < -180 + this.getDirectionalDeadzone() && tempDirection > 180 - this.getDirectionalDeadzone())
				tempDirection = 180;
			// else if (tempDirection < -135 + this.getDirectionalDeadzone()
			// && tempDirection > -135 - this.getDirectionalDeadzone())
			// tempDirection = -135;
