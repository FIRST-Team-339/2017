...
public class Hardware
{
	...
	public static DoubleSolenoid gearIntakeSolenoid = new DoubleSolenoid(0, 1);
	...
	public static UsbCamera camForward = CameraServer.getInstance().startAutomaticCapture(0);
	...
	public static VisionProcessor testingProcessor = new VisionProcessor("10.3.39.11", CameraModel.AXIS_M1013);
	// -------------------------------------
	...
	public static MomentarySwitch ringlightSwitch = new MomentarySwitch(leftOperator, 11, false);
	...
	public static MomentarySwitch autoTest = new MomentarySwitch(leftOperator, 4, false);

	public static MomentarySwitch gearToggle = new MomentarySwitch(leftDriver, 2, false);
	...
	public static MecanumTransmission transmission = new MecanumTransmission(leftFrontMotor, rightFrontMotor,
	...
	public static org.usfirst.frc.team339.HardwareInterfaces.newtransmission.Drive newDrive = new org.usfirst.frc.team339.HardwareInterfaces.newtransmission.Drive(
			transmission, leftFrontEncoder, rightFrontEncoder, leftRearEncoder, rightRearEncoder, ultraSonic, driveGyro,
			testingProcessor);
	...
	// public static SpeedTester RRSpeedTester = new
	// SpeedTester(Hardware.rightRearEncoder, Hardware.speedTesterTimer);
	...
	public static final GearIntake gearIntake = new GearIntake(gearIntakeMotor, gearIntakeSolenoid);
	...
	public static SpeedTester rightFrontTest = new SpeedTester(rightFrontEncoder, speedTesterTimer);
