 ...
 */
public class ImageProcessing_old
{
 ...
 * @written 28 Jan 2014
 */
public ImageProcessing_old (KilroyCamera camera)
{
    this.camera = camera;
}
 ...
 * @written 28 Jan 2014
 */
public ImageProcessing_old (KilroyCamera camera, int hueLow, int hueHigh,
