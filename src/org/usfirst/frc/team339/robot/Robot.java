 ...
 */
public static final double KILROY_XVIII_FIRST_GEAR_PERCENTAGE = 1;
...
public static double shooterP = .025;

public static double shooterI = .00005;

public static double shooterD = .8;
