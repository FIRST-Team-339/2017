...
import org.usfirst.frc.team339.Utils.pidTuning.MotorControllerPIDTuner;
...
/*
 * private static SmartDashboardPIDTunerDevice PIDTuner = new
 * SmartDashboardPIDTunerDevice(
 * CanTuner);
 */
...
public static void periodic ()
{
    ...
    if (tunePIDLoop == true)
        {
        PIDTuner.update();
        // System.out.println(Hardware.rightRearEncoder.pidGet());
        // System.out.println(pwmTalonTuner.getInput());
        }
    // Hardware.shooterMotor
    // .set(tempSetpoint);
