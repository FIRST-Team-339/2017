...
public static void periodic ()
{
    ...
    // .set(tempSetpoint);
		...
		} else if (Hardware.rightOperator.getRawButton(6) == true && Hardware.rightOperator.getRawButton(7) == true)
		{
			Hardware.climberMotor.set(1);
		...
		if (isTestingCamera == true)
		{
			alignValue = Hardware.autoDrive.driveToGear(.4, .4, .1212, .05,
					Hardware.leftOperator.getRawButton(6) || Hardware.leftOperator.getRawButton(7), .15, .1);
		...
		if (isTestingDrive == true)
		{
			...
			if (Hardware.leftOperator.getRawButton(6) == true || Hardware.leftOperator.getRawButton(7) == true)
			{
