...
public class Teleop
    {
        ...
        public static void init ()
            {
                ...
                Hardware.gimbalMotor.setFeedbackDevice(
                ...
                if (Hardware.isRunningOnKilroyXVIII == true)
                    {
                        ...
                        Hardware.mecanumDrive
                                .setFirstGearPercentage(Robot.FIRST_GEAR);
                        ...
                        Hardware.mecanumDrive.setDeadbandPercentageZone(
                                Hardware.joystickDeadzone);
                        ...
                        Hardware.rightUS
                                .setNumberOfItemsToCheckBackwardForValidity(3);
        ...
        /**
         * stores print statements for future use in the print "bank",
         * statements are commented out when not in use, when you write a new
         * print statement, "deposit" the statement in the correct "bank" do not
         * "withdraw" statements, unless directed to.
         * 
         * NOTE: Keep the groupings below, which coorespond in number and order
         * as the hardware declarations in the HARDWARE class
         * 
