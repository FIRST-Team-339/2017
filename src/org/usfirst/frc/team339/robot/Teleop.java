...
public class Teleop {
	...
	public static void init() {
		...
		if (Hardware.isRunningOnKilroyXVIII == true) {
			...
			Hardware.rightRearEncoder.setDistancePerPulse(Robot.ENCODER_DISTANCE_PER_PULSE_KILROY_XVIII);
			Hardware.leftRearEncoder.setDistancePerPulse(Robot.ENCODER_DISTANCE_PER_PULSE_KILROY_XVIII);
			Hardware.rightFrontEncoder.setDistancePerPulse(Robot.ENCODER_DISTANCE_PER_PULSE_KILROY_XVIII);
			Hardware.leftFrontEncoder.setDistancePerPulse(Robot.ENCODER_DISTANCE_PER_PULSE_KILROY_XVIII);
			...
			// Hardware.leftFrontEncoder.setReverseDirection(true);
			// Hardware.leftRearEncoder.setReverseDirection(false);
			Hardware.rightRearEncoder.setDistancePerPulse(Robot.ENCODER_DISTANCE_PER_PULSE_KILROY_XVII);
			Hardware.leftRearEncoder.setDistancePerPulse(Robot.ENCODER_DISTANCE_PER_PULSE_KILROY_XVII);
			Hardware.leftFrontEncoder.setDistancePerPulse(Robot.ENCODER_DISTANCE_PER_PULSE_KILROY_XVII);
			Hardware.rightFrontEncoder.setDistancePerPulse(Robot.ENCODER_DISTANCE_PER_PULSE_KILROY_XVII);
	...
	public static void periodic() {
		...
		if (Hardware.rightOperator.getRawButton(5) == true && cameraPositionHasChanged == false) {
		...
		if (changeCameraServoPosition == true) {
			...
			if (Hardware.cameraServo.getAngle() == LOWER_CAMERASERVO_POSITION) {
			...
			else if (Hardware.cameraServo.getAngle() == HIGHER_CAMERASERVO_POSITION) {
		...
		if (changeCameraServoPosition == true && Hardware.leftOperator.getRawButton(4) == false) {
